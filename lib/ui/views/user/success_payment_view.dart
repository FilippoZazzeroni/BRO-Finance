      ...
      body: RectangleWithGradient(
        ...
        child: Column(
          ...
          children: [
            ...
            VerticalSpace(20.0),
            Text("The payment was successful", style: CurrencyStyle.title,),
            Text(
              "Thank you for your contribution, now you are part of bro finance",
              style: CurrencyStyle.description,),
            VerticalSpace(20.0),
            TextButton(onPressed: () async {
              final amountPayed = await SharedPreferencesHelper.getValue("userPaymentAmount");
              print(amountPayed);
              pushRouteAndRemoveCurrentInStack(context, STGRouter.userRoute);
            }, child: Text("go to account", style: CurrencyStyle.getDescriptionFrom(SColors.blueDark),))
          ],
        ),
      ),
    );
