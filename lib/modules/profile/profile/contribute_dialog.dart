                ...
                child: Padding(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text(
                      ...
                      style: CurrencyStyle.getDescriptionFrom(Colors.white, textSize: 18.0),
                    ),
                    Expanded(
                      child: Container(
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintStyle: CurrencyStyle.getDescriptionFrom(Colors.white70, textSize: 20)),
                              ),
                            ),
                            const SizedBox(
                              width: 10.0,
                    ...
                    TextButton(
                      ...
                      child: Text(
                        "Review SAFT here",
                        style: CurrencyStyle.getDescriptionFrom(Colors.redAccent, textSize: 18.0),
                      ),
                    ),
                    ElevatedButton(
                        onPressed: () {},
