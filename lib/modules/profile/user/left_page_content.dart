...
class LeftSidePage extends StatelessWidget {
  ...
  Future<List<Widget>> _getBodyOfBinanceData() async {
    ...
    children.add(SizedBox(
      ...
      child: GridView(
        gridDelegate:
            SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, mainAxisExtent: gridChildren[0].length * 115),
        children: [
          Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Coin(
              radius: 55.0,
              asset: "assets/images/${element.symbol.currency1.toLowerCase()}.png",
            ),
            Text(
              "  /  ",
              style: CurrencyStyle.description,
            ...
            Coin(
              radius: 55.0,
              asset: "assets/images/${element.symbol.currency2.toLowerCase()}.png",
            ),
          ],
        ),
      ],
